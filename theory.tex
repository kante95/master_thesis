...
\end{equation}
where $\varepsilon$ is a the unit polarization vector. The next step is to work out the dipole operator, this can be done by applying the identity $\ket{g}\bra{g} + \ket{e}\bra{e}$ on $d$. Due to parity arguments [], only the non diagonal terms are non vanishing, giving
\begin{equation}
