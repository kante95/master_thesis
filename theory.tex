...
\begin{equation}
E_{\pm} = -\frac{\Delta}{2} \pm \frac{\hbar}{2}\sqrt{\Delta^2 +\Omega^2}.
\end{equation}
In the limit $\Delta \gg \Omega$, dressed states tend to the bare states $\ket{+} \to \ket{e},\ket{-}\to \ket{g}$, and the energies becomes
\begin{equation}
E_{\pm} \to -\frac{\hbar \Omega}{2} \pm \frac{\hbar \Omega}{2} + \frac{\hbar \Omega^2}{4\Delta} \implies \delta = \frac{\Omega^2}{2\Delta}.
\end{equation}
