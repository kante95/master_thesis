...
After the tests presented in the previous sections, the setup was installed next to the ion chamber and focused on the ions as described in section \ref{design4}. Here more advanced quantum optics experiment could be carried out. The first one is a Ramsey Spectroscopy experiment, where Ramsey fringes has been measured on four loaded ions. This experiment allowed a direct measure of the focus spot and the addressing error. The second experiment involves three ions and the goal was to generate photons via Raman process from one single ion leaving the state of the other two unaltered.
