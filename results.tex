...
The main goal of having an addressed 393nm setup is to generate single photon from individual ion in a chain. In this experiment we tested this feature by loading a string of 3 ions, pointing the 393nm light at the central ion and monitoring the photon production and the ions state as well.
\begin{figure}[H]
\centering
