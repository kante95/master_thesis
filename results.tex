...
\caption{Scheme of the razor scan. A translation stage allows for moving the blade in two direction $x$ perpendicular to the beam, and $z$ along the beam optical axis.}
\label{razorscan}
\end{figure}
